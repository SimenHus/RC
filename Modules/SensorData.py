...
class SensorData:
    ...
    def sample(self, u): # Sample filter or sumfn
        ...
        roll = np.arctan2(linAcc[1], linAcc[2])
        pitch = np.arctan2(linAcc[0], (linAcc[1]**2 + linAcc[2]**2)**(1/2))
        y = np.hstack((roll, pitch, gyroRaw, linAcc*self.dt)) # Assuming IMU in CoG
    ...
    def stateFunc(self):
        ...
        RaDot = Ra*self.skew(wia*self.dt)
    ...
    def measurementFunc(self):
        ...
        H = sp.Matrix.vstack(roll, pitch, vc, wia)
